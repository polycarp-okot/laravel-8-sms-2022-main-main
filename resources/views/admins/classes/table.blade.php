...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <a class="btn btn-primary btn-sm btn-flat" href="{{ route('classes.create') }}">Create New Class</a>
        </div>
                    ...
                    <tbody>
                        @forelse ($classes as $class)
                            <tr>
                                ...
                                <td>{{ $class->status == 0 ? 'InActive' : 'Active' }}</td>
                                <td>
                                    <div class="btn-group">
...
<x-modals.delete :title="'Classes'"></x-modals.delete>
